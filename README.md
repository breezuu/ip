...
7. After that, locate the `src/main/java/Nexus.java` file, right-click it, and choose `Run Nexus.main()` (if the code editor is showing compile errors, try restarting the IDE). If the setup is correct, you should see something like the below as the output:
   ```
   Hello from
   _   _                      
   | \ | | _____  ___   _ ___
